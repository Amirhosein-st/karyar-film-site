...
import '../AddMovieBase64/AddMovie.css';
  ...
  return (
    <div className="add-movie-page">
      ...
      <form onSubmit={handleSubmit} className="add-movie-form">
        ...
        <input type="text" placeholder="IMDB ID" value={imdbId} onChange={(e) => setImdbId(e.target.value)} required />
        ...
        <input type="text" placeholder="IMDB Rating" value={imdbRating} onChange={(e) => setImdbRating(e.target.value)} />
        
        <input type="text" placeholder="IMDB Votes" value={imdbVotes} onChange={(e) => setImdbVotes(e.target.value)} />
