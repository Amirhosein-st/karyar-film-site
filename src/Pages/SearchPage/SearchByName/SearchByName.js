...
function SearchByName() {
    ...
    return (
        <div className='SearchByName-back'>
            ...
            {loading ? (
                <p style={{color:("white") , paddingTop:("1vmax")}}>Loading...</p>
            ) : (
                <>
                    <div className='film-details-search-back'>
                        {movies.map((movie) => (
                            <div className="film-details-search" key={movie.id} onClick={() => handleMovieClick(movie.id)} style={{justifyContent:("flex-end")}}>
                    ...
                    <div className='pagination-search'>
                        ...
                        <button onClick={() => handlePageChange(page + 1)} disabled={currentPage === allPages}>
                            Next
                        </button>
                    </div>
