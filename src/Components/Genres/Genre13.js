...
const Genre13 = () => {
  ...
  const handleShowMoreClick = () => {
    localStorageService.setItem('NumberGenre', 13);
    localStorageService.setItem('NameGenre', 'Family');
  ...
  const fetchMovies = async () => {
    const response = await axios.get(`https://moviesapi.ir/api/v1/genres/13/movies?page=`);
      ...
      {isLoading ? (
        ...
        <div className="film-list-page-Genre">
          <div className="film-list-Genre">
            <div className="film-details-Genre-Genre-name"><p>Genre: Family</p></div>
