...
const Genre9 = () => {
  ...
  const handleShowMoreClick = () => {
    localStorageService.setItem('NumberGenre', 9);
    localStorageService.setItem('NameGenre', 'Comedy');
  ...
  const fetchMovies = async () => {
    const response = await axios.get(`https://moviesapi.ir/api/v1/genres/9/movies?page=`);
      ...
      {isLoading ? (
        ...
        <div className="film-list-page-Genre">
          <div className="film-list-Genre">
            <div className="film-details-Genre-Genre-name"><p>Genre: Comedy</p></div>
