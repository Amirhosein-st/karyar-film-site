        ...
        <div className="icons-container">
          <div className="man-icons">
            ...
            {icons
              ...
              .map((icon) => (
                <div key={icon.id} className="bar-2" id={icon.id} onClick={() => handleSelectIcon(icon.id)}></div>
              ))}
          </div>
          <div className="woman-icons">
            ...
            {icons
              ...
              .map((icon) => (
                <div key={icon.id} className="bar-3" id={icon.id} onClick={() => handleSelectIcon(icon.id)}></div>
              ))}
          </div>
        </div>
      </div>
